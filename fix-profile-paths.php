...
// This script ensures profile photos are in the public/profile-photos/ directory

// Enable error reporting
ini_set('display_errors', 1);
error_reporting(E_ALL);

echo "<h1>Fix Profile Photo Paths</h1>";
...
// Step 4: Create a simple JavaScript fix for the edit page
$jsContent = <<<'JS'
...
$jsPath = $jsDir . '/fix-profile-paths.js';
if (file_put_contents($jsPath, $jsContent)) {
    echo "<p style='color:green;'>✅ Created JavaScript fix: public/js/fix-profile-paths.js</p>";
} else {
    echo "<p style='color:red;'>❌ Failed to create JavaScript fix</p>";
}

// Create bookmarklet
$bookmarklet = "javascript:(function(){var s=document.createElement('script');s.src='/js/fix-profile-paths.js?v='+new Date().getTime();document.head.appendChild(s);})();";
?>
<!DOCTYPE html>
<html>
<head>
    <title>Fix Profile Photo Paths</title>
    <style>
        body {
...
<body>
    ...
    <pre>&lt;script src="{{ asset('js/fix-profile-paths.js') }}?v={{ time() }}"&gt;&lt;/script&gt;</pre>
    ...
    <ol>
        <li>Verified public/profile-photos directory exists</li>
        <li>Copied profile photos from storage to public directory</li>
        <li>Updated database paths to use profile-photos/</li>
        <li>Created JavaScript fix for the edit page</li>
    </ol>
</body>
</html> 