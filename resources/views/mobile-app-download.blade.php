                        ...
                        <div class="col-md-6">
                            <div class="card h-100 border-0 shadow-sm">
                                <div class="card-body text-center p-4">
                                    ...
                                    <a href="{{ url('/download-app.php') }}" class="btn btn-success btn-lg w-100 mb-2">
                                        <i class="bi bi-download me-2"></i> Download APK
                                    </a>
                                    <div class="mt-2 small">
                                        Alternative download methods:
                                        <div class="mt-1">
                                            <a href="{{ url('/mobile/apk/download.php') }}" class="btn btn-outline-success btn-sm">Method 1</a>
                                            <a href="{{ url('/mobile/apk/ckp-kofa-app.apk') }}" class="btn btn-outline-success btn-sm">Direct Link</a>
                                            <a href="{{ url('/download-app.php?debug=1') }}" class="btn btn-outline-success btn-sm">Debug</a>
                                        </div>
                                    </div>
