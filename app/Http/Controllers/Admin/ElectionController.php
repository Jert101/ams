...
class ElectionController extends Controller
{
    ...
    public function settings()
    {
        $electionSetting = ElectionSetting::getActiveOrCreate();
        $electionSetting->updateStatusBasedOnDate();
        return view('admin.election.settings', compact('electionSetting'));
    }
    ...
    public function positions()
    {
        $electionSetting = ElectionSetting::getActiveOrCreate();
        $positions = ElectionPosition::where('election_settings_id', $electionSetting->id)->get();
        return view('admin.election.positions', compact('positions', 'electionSetting'));
    }
    ...
    public function candidates()
    {
        ...
        $positions = ElectionPosition::where('election_settings_id', $electionSetting->id)->get();
        return view('admin.election.candidates', compact('candidates', 'positions', 'electionSetting'));
    }

    /**
     * Get position data for editing.
     */
    public function editPosition(ElectionPosition $position)
    {
